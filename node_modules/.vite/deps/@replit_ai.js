...
// node_modules/@replit/ai/dist/index.mjs
...
var AbortError = class extends Error {
  constructor(message, code) {
    super(message != null ? message : "The operation was aborted");
    __publicField(this, "type");
    __publicField(this, "code");
    this.type = "aborted";
    this.code = code != null ? code : "ABORT_ERR";
  }
};
...
var IncrementalJSONParser = class {
  constructor() {
    __publicField(this, "buffer");
    __publicField(this, "bufferIndex");
    __publicField(this, "state");
    __publicField(this, "level");
    __publicField(this, "escaped");
...
var _a;
var baseUrl = (_a = process.env.MODEL_FARM_URL) != null ? _a : "https://production-modelfarm.replit.com/";
...
function processJSON(json) {
  var _a2, _b;
  if (!((_b = (_a2 = json.responses[0]) == null ? void 0 : _a2.candidates[0]) == null ? void 0 : _b.message)) {
...
function processJSON2(json) {
  var _a2, _b;
  if (!((_b = (_a2 = json.responses[0]) == null ? void 0 : _a2.choices[0]) == null ? void 0 : _b.content)) {
    throw new Error("Expected at least one message");
  }
  return {
...
//# sourceMappingURL=@replit_ai.js.map
